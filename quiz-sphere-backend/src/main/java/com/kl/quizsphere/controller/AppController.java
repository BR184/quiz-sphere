...
import com.kl.quizsphere.model.dto.app.AppAddRequest;
import com.kl.quizsphere.model.dto.app.AppEditRequest;
import com.kl.quizsphere.model.dto.app.AppQueryRequest;
import com.kl.quizsphere.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        // 在此处将实体类和 DTO 进行转换-App没有JSON转换不需要
        App app = new App();
        ...
        app.setReviewStatus(ReviewStatusEnum.PENDING.getValue());
        // 写入数据库
