...
/** aiGenerateQuestion POST /api/question/ai/generate_question */
export async function aiGenerateQuestionUsingPost(
  body: API.QuestionAiGenerateRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseListQuestionContentDTO_>('/api/question/ai/generate_question', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** aiFlowableGenerateQuestion GET /api/question/ai/generate_question/flow */
export async function aiFlowableGenerateQuestionUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.aiFlowableGenerateQuestionUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.SseEmitter>('/api/question/ai/generate_question/flow', {
    method: 'GET',
    params: {
      ...params,
    },
